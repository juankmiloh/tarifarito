  ...
  <div class="login-container">
        ...
        <el-row>
          ...
          <el-col :span="24" style="border: 0px solid;">
            <div class="grid-textoTarifarito">
              <span class="letraT">T</span>
              <span class="otrasLetras">
                <b>ARIFARITO</b>
              </span>
            </div>
          </el-col>
          ...
          <el-col :span="24" style="border: 0px solid blue; height: 100%;">
            <div class="grid-logoSuper">
              ...
              <div class="grid-textSuper">
                ...
                <br>
                <span style="font-size: 130%;">Superintendencia de Servicios</span>
                <br>
    ...
    <div class="footer">
      <span class="textoFooter">
        <b>CIAD</b> - Centro de Investigación y Análisis de Datos
      </span>
    </div>
  </div>
</template>
...
<style lang="scss" scoped>
	$bg: linear-gradient(
		...
		rgba(242, 246, 248, 1) 27%,
		rgba(216, 225, 231, 1) 51%,
		rgba(181, 198, 208, 1) 99%,
