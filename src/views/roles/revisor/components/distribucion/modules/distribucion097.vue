...
import distribucion097 from './../options/distribucion097'
...
export default {
  ...
  methods: {
    ...
    reportar() {
      this.valoresDiferencia = false
      this.$alert('<p style="text-align: center;">La empresa no utilizó la demanda real no regulada para el cálculo del IPRSTN</p>', 'TARIFARITO REPORTA', {
