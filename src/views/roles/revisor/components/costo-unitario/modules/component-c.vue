<template>
  <div class="components-container" style="border: 0px solid red; margin: 0;">
    ...
    <!-- <el-button @click="showModel">Prueba</el-button> -->
  </div>
</template>
...
import ComponentesComercializacion from './../options/componentC'
import ComponentesCFooter from './../options/componentCFooter'
...
export default {
  ...
  data() {
    return {
      ...
      components: ComponentesComercializacion,
      componentsFooter: ComponentesCFooter,
      input: 0,
      values: [],
      valuesFooter: [],
      actualiza: false
  ...
  methods: {
    showModel() {
      console.log('Modelo: ', this.values.ipcm1_2)
    },
