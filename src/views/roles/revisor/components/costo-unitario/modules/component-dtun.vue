...
import componentesTransmision from './../options/componentsDtun.js'
export default {
  name: 'ViewDtun',
  data() {
    return {
  ...
  methods: {
    ...
    reportar() {
      this.showCard = false
      this.$alert('La empresa publico Dtun de una ADD diferente', 'TARIFARITO REPORTA', {
